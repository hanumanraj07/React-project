...
export default function Nav() {
    ...
    return (
        ...
        // Navigation Bar.....
        <div className="w-full fixed top-0 z-78 border-0 backdrop-blur-2xl">

            {/* Actual div which will contain the total three content used in navbar */}
            <div className="flex items-center justify-between px-6 py-3 border-2 border-amber-600 sm:px-12 md:px-24 lg:40 ">
                {/* Logo */}
                <div>
                ...
                {/* mobile nav bar */}
                {
                    menuBar && <div className=" font-semibold text-2xl  flex flex-col items-center justify-center space-y-6 fixed top-0 right-0 h-screen w-40 bg-amber-400 sm:hidden">
                        ...
                        <button className=" flex items-center gap-1 px-1 py-1 bg-white rounded-full">
                        Contact us
                        <FaArrowRightLong />
                    </button>
                    </div>
